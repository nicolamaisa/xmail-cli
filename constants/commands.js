...
export const COMMANDS = [
    ...
    { id: '/logs', description: 'Mostra log recenti, o stream live con /logs watch e stop con /logs stop' },
    { id: '/download', description: 'Scarica una release da x-master-distribution, verifica SHA256 e opzionalmente estrae' },
    { id: '/update', description: 'Aggiorna XMail: check, download+SHA, apply safe, stop/pull/up e opzione -d dry-run' },
