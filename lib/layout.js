...
export function layoutDashboard(ui, screen) {
    const { logoContainer, logAreaSuggestion, dashSuggestions, header, sideInfo, inputContainer, logArea, bottomInfo } = ui;
    ...
    logAreaSuggestion.left = 1;
    logAreaSuggestion.width = leftAreaEnd - 1;
